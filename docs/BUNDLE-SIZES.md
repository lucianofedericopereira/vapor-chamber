...
# Bundle sizes — vapor-chamber v1.15.0
...
from it is ~3.6 KB brotli, not 24.2 KB).

| export | min KB | gzip KB | brotli KB |
|---|--:|--:|--:|
| `.` | 83.0 | 27.6 | 24.2 |
| `./transports` | 11.6 | 4.7 | 4.2 |
| `./directives` | 19.3 | 6.9 | 6.1 |
| `./transitions` | 17.1 | 6.1 | 5.5 |
| `./ssr` | 1.6 | 0.8 | 0.7 |
| `./vite` | 3.0 | 1.3 | 1.2 |
...
| `./iife` | 39.7 | 13.5 | 12.0 |
| `./iife-core` | 25.5 | 8.5 | 7.6 |
| `./iife-elements` | 28.9 | 9.7 | 8.7 |

## IIFE variants (`<script>` drop-ins)

| variant | min KB | gzip KB | brotli KB |
|---|--:|--:|--:|
| `vapor-chamber (full)` | 37.8 | 12.2 | 11.0 |
| `vapor-chamber-core` | 25.9 | 8.4 | 7.5 |
| `vapor-chamber-elements` | 27.6 | 8.9 | 8.0 |
