...
# Bundle sizes — vapor-chamber v1.14.0
...
from it is ~3.6 KB brotli, not 24.1 KB).

| export | min KB | gzip KB | brotli KB |
|---|--:|--:|--:|
| `.` | 82.5 | 27.5 | 24.1 |
| `./transports` | 11.7 | 4.7 | 4.2 |
| `./directives` | 19.2 | 6.8 | 6.1 |
| `./transitions` | 16.9 | 6.0 | 5.4 |
| `./ssr` | 1.6 | 0.8 | 0.7 |
| `./vite` | 3.0 | 1.3 | 1.2 |
