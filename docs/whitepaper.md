...
Vapor Chamber is a <!-- vc:sizeCore -->4.2<!-- /vc:sizeCore --> KB-brotli command bus built for Vue Vapor. It provides a semantic,
...
<!-- vc:sizeStore -->0.6<!-- /vc:sizeStore --> KB rather than a competitor: the existing plugin catalogue
...
| full      | SPAs that grew big (realtime + undo/redo + persistence)   | <!-- vc:sizeIifeFull -->11.1<!-- /vc:sizeIifeFull --> KB |
...
| Bundle size | ~50KB | ~15KB | ~14KB | <!-- vc:sizeCore -->4.2<!-- /vc:sizeCore --> KB brotli core |
...
- **<!-- vc:sizeCore -->4.2<!-- /vc:sizeCore --> KB brotli dispatch core** - measured ([BUNDLE-SIZES.md](./BUNDLE-SIZES.md)); this line read "~4 KB gzipped" while every other size in this document is brotli, which is a different number for the same artifact
...
tests/                           (<!-- vc:testFiles -->131<!-- /vc:testFiles --> files, <!-- vc:tests -->1950<!-- /vc:tests --> tests)
```
