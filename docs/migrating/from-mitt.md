...
**<!-- vc:sizeIifeCore -->7.7<!-- /vc:sizeIifeCore --> KB brotli**, i.e. a
...
measures **<!-- vc:benchFastLaneVsMitt -->1.83<!-- /vc:benchFastLaneVsMitt -->x
mitt** - generated by `npm run bench` and published by `npm run docs:stamp`, not
typed here. See [from-event-emitter.md](./from-event-emitter.md) for the
nanoevents comparison and the removal-mode trade-off.
